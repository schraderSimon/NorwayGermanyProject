...
def plotstuff():
    ...
    sns.kdeplot(num_weeks_DEtoNO_delay1,color="orange",bw_adjust=2,label="DE to NO, delay 1")
    plt.xlabel("Number of weeks")
    plt.ylabel("Probability")
    plt.legend()
    plt.title(r"weeks exporting, n=%d, year=%d, years=%d"%(num_simulations,start_year,num_years))
